...
@Component({
    selector:"employee-family-form",
    templateUrl:"employee-family-form.component.html",
...
export class EmployeeFamilyFormComponent implements OnInit {
...
arrLastEducation = ['SD','SMP','SMA','S1','S2']
arrMaritalStatus = ['Single','Married'];
    ...
    ngOnInit(){
        ...
        setTimeout(()=>{
            var selectrGender:any = document.getElementById('selectrGender')
            var options = {searchable:true}
            var selectrGenderDefault = new Selectr(selectrGender,options)

            var selectrRelationship:any = document.getElementById('selectrRelationship')
            var selectrRelationshipDefault = new Selectr(selectrRelationship,options)

            var selectrBloodType:any = document.getElementById('selectrBloodType')
            var selectrBloodTypeDefault = new Selectr(selectrBloodType,options)

            var selectrLastEducation:any = document.getElementById('selectrLastEducation')
            var selectrLastEducationDefault = new Selectr(selectrLastEducation,options)

            var selectrMaritalStatus:any = document.getElementById('selectrMaritalStatus')
            var selectrMaritalStatusDefault = new Selectr(selectrMaritalStatus,options)
        },800)
