...
@Component({
    selector:"employee-payment-method",
    templateUrl:"employee-payment-method.component.html",
...
export class EmployeePaymentMethodComponent implements OnInit {
...
photoProfile:any;
modelPaymentMethod:string;
modelBankName:string;
modelBankBranchName:string;
modelBankLocation:string;
modelBankAddress:string;
modelAccountName:string;
modelAccountNumber:string;
