...
@Component({
    selector:"work-structure-grade-list",
    templateUrl:"work-structure-grade-list.component.html",
...
export class WorkStructureGradeListComponent implements OnInit {
  
arrBreadCrumb = ['Work Structure','Grade']
...
@ViewChild('tableGrade') table
    ...
    onSelect({selected}) {
       ...
       if (this.selected.length > 0){
         ...
         let gradeName = this.methodServices.encryptOnline(this.selected[0].gradeName)
        ...
        //  let positionName = this.selected[0].positionName
         this.aktif_table = false
        //  this.urlEndParse = 'Detail'
         this.router.navigate(['/work-structure/grade','grade-form'],
                {queryParams:{id:id,
    ...
    redirectForm(dataRow) {
        ...
        this.router.navigate(['/work-structure/grade','grade-form'],{
            queryParams: {
                ...
                gradeName: this.methodServices.encryptOnline(dataRow.gradeName.toString()),
