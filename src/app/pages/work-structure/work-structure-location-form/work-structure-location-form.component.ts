...
@Component({
    selector:"work-structure-location-form",
    templateUrl:"work-structure-location-form.component.html",
...
export class WorkStructureLocationFormComponent implements OnInit, OnDestroy {
...
modelaTownCity:string;
    ...
    ngOnInit(){
        ...
        this.activatedRoute.queryParams.subscribe(result=>{
            ...
            if (typeof(result.locationName) != "undefined") {
                let decryptLocation = this.methodServices.decryptOnline(result.locationName)
                this.modelLocationName = decryptLocation
            }
