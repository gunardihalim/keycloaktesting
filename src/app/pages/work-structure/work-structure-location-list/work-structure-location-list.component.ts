...
@Component({
    selector:"work-structure-list-location-list",
    templateUrl:"work-structure-location-list.component.html",
...
export class WorkStructureLocationListComponent implements OnInit {
  
arrBreadCrumb = ['Work Structure','Location']
...
@ViewChild('tableLocation') table
    ...
    ngOnInit(){
        ...
        //                             locationName:result[key][i].name})
        //             }
        //         }
        //     }
        //     setTimeout(()=>{
        ...
        //         postalCode:'120711',
        //         townCity:'Jakarta',
        //         province:'Greater Area of Jakarta',
        //         country:'Indonesia',
        //     },
        //     {
        //         effectiveDate:'25-Mar-2020',
        //         activeStatus:true,
        //         locationName:'Pontianak',
        //         description:'Work as Supervisor',
    ...
    onSelect({selected}) {
       ...
       if (this.selected.length > 0){
         ...
         let locationName = this.methodServices.encryptOnline(this.selected[0].locationName)
         this.aktif_table = false
         this.router.navigate(['/work-structure/location','location-form'],
                {queryParams:{id:id,
    ...
    redirectForm(dataRow) {
        ...
        this.router.navigate(['/work-structure/location','location-form'],{
            queryParams: {
                ...
                locationName: this.methodServices.encryptOnline(dataRow.locationName.toString()),
  ...
  activeStatusProc(){
    ...
    backTable(event){
      if (event.toLowerCase() == 'work structure' ||
          event.toLowerCase() == 'location'){
            this.router.navigate(['/work-structure/location'])
