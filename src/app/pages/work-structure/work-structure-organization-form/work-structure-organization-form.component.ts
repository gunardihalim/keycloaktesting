...
@Component({
    selector:"work-structure-organization-form",
    templateUrl:"work-structure-organization-form.component.html",
...
export class WorkStructureOrganizationFormComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(){
        ...
        this.activatedRoute.queryParams.subscribe(result=>{
            ...
            if (typeof(result.organizationName) != "undefined") {
                let decryptOrganization = this.methodServices.decryptOnline(result.organizationName)
                this.modelOrganizationName = decryptOrganization
            }
            ...
            if (typeof(result.groupName) != "undefined") {
                let decryptGroup = this.methodServices.decryptOnline(result.groupName)
                this.modelGroupName = decryptGroup
            }
