...
@Component({
    selector:"work-structure-position-form",
    templateUrl:"work-structure-position-form.component.html",
...
export class WorkStructurePositionFormComponent implements OnInit, OnDestroy {
...
modelOrganizationName:string;
modelActiveStatus:boolean;
modelJobName:string;
modelLocationName:string;
    ...
    ngOnInit(){
        ...
        this.activatedRoute.queryParams.subscribe(result=>{
            ...
            if (typeof(result.positionName) != "undefined") {
                let decryptPosition = this.methodServices.decryptOnline(result.positionName)
                this.modelPositionName = decryptPosition
            }
            ...
            if (typeof(result.organizationName) != "undefined") {
                let decryptOrganizationName = this.methodServices.decryptOnline(result.organizationName)
                this.modelOrganizationName = decryptOrganizationName
            }
            if (typeof(result.jobName) != "undefined") {
                let decryptJobName = this.methodServices.decryptOnline(result.jobName)
                this.modelJobName = decryptJobName
            }
