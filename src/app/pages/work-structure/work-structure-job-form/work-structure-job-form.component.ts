...
@Component({
    selector:"work-structure-job-form",
    templateUrl:"work-structure-job-form.component.html",
...
export class WorkStructureJobFormComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(){
        ...
        this.activatedRoute.queryParams.subscribe(result=>{
            ...
            if (typeof(result.jobName) != "undefined") {
                let decryptJob = this.methodServices.decryptOnline(result.jobName)
                this.modelJobName = decryptJob
            }
